...
const GlossaryPage: React.FC = () => {
  ...
  useEffect(() => {
    if (showModal) {
      // Evitar scroll de la página principal
    ...
    // Cleanup: restaurar scroll de la página cuando se cierre el modal
    return () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Modal con scroll interno - FUNCIONAL */}
      {showModal && (
        <div 
        ...
        >
          <div 
            className="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[85vh] flex flex-col mx-auto"
          ...
          >
            ...
            <div 
              ...
              style={{ minHeight: '200px', maxHeight: 'calc(85vh - 100px)' }}
            >
              <div
                ref={modalContentRef}
